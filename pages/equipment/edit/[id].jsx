  ...
  useEffect(() => {
    const fetchEquipment = async () => {
      ...
      try {
        ...
        const response = await axios.get(`https://esi-flow-back-u9go.onrender.com/equipments/${equipmentId}`)
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      try {
        ...
        const response = await axios.put(`https://esi-flow-back-u9go.onrender.com/equipments/${equipmentId}`, equipmentData)
