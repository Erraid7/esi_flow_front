...
const TechnicianDashboard = () => {
    return (
        ...
        <div className="w-full max-w-4xl px-4 py-8">
            <h1 className="text-2xl font-bold mb-4">"technician_dashboard"</h1>
            {/* Add your technician dashboard content here */}
            <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
            <h2 className="text-xl font-semibold mb-4">"welcome_technician"</h2>
