...
const Toast = ({ message, type, visible, onClose }) => {
  ...
  return (
    <div className={`fixed top-4 right-4 ${bgColor} text-white p-4 rounded shadow-lg flex items-center z-50 animate-fade-in`}>
      <div className="mr-3">
        {icon}
      </div>
      <p>{message}</p>
  ...
  return (
    <div className={`flex flex-col gap-2 ${className}`}>
      ...
      <div className="relative">
        ...
        {icon && (
          <div 
            className="absolute inset-y-0 right-0 flex items-center pr-3 text-neutral-950"
            onClick={onIconClick}
          >
            {icon}
          </div>
      ...
      {comment && !error && (
        <div className="text-xs text-neutral-800 mt-1">{comment}</div>
      )}
    </div>
  );
};
...
const PasswordField = ({ 
  ...
  // Determine the strength label and color
  const getStrengthLabel = () => {
    if (strength === 0) return { label: 'Too weak', color: 'bg-gray-200' };
...
export default function UserEditForm() {
  ...
  const [user, setUser] = useState({
    ...
    email: "djemal@esi.dz",
    phone: "(555) 123-4567",
    biography: "Experienced maintenance administrator with 5+ years in facility management. Specialized in preventive maintenance planning and team coordination.",
    profession: "Teacher",
    role: "Admin"
  });
      ...
      <div className="flex overflow-y-auto pb-8 w-full bg-neutral-50 dark:bg-neutral-990">
        <div className="px-4 sm:px-10 lg:px-20">
          <div className="flex flex-col items-start gap-6 mb-6 pt-6 text-neutral-950 dark:text-neutral-100">
            ...
            <h1 className="text-xl lg:text-2xl font-russo">Edit User</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            <FormSection title="Basic Information">
              <div className="flex flex-col gap-4">
                ...
                <FormField
                  ...
                  icon={<Mail size={16} />}
                  comment="Changing the email will require a confirmation code*"
                  error={errors.email}
                  required={true}
                />
                ...
                <FormField
                  ...
                  icon={<Phone size={16} />}
                  comment="Changing the Phone Number will require a confirmation code*"
                  error={errors.phone}
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <FormSection>
                <DropdownField
                  ...
                  updateText="Update the profession of user"
              ...
              <FormSection>
                <DropdownField
                  ...
                  updateText="Update the role of user" 
                  description="Admin role grants full access to all system features including user management, reports, and system configuration."
                  options={roleOptions}
                />
              </FormSection>
            </div>
            ...
            <FormSection title="Account Setup">
              <div className="text-sm text-gray-600 dark:text-gray-300 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-md flex items-start">
                ...
                <p>Changing the Password will require a confirmation code sent to your email.*</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <PasswordField
                  ...
                  comment="Password must be at least 8 characters with numbers and special characters"
