...
export default function RequestEditForm() {
  ...
  useEffect(() => {
    const fetchEquipment = async () => {
      ...
      try {
        ...
        const response = await axios.get("https://esi-flow-back-u9go.onrender.com/equipments")
  ...
  useEffect(() => {
    const fetchRequestData = async () => {
      ...
      try {
        ...
        const response = await axios.get(`https://esi-flow-back-u9go.onrender.com/requests/${requestId}`)
  ...
  const uploadPhoto = async (photo) => {
    ...
    try {
      const response = await axios.post("https://esi-flow-back-u9go.onrender.com/requests/upload", formData, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      try {
        ...
        const response = await axios.put(`https://esi-flow-back-u9go.onrender.com/requests/${request.id}`, requestData)
