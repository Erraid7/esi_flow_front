  ...
  return (
    <div className="bg-neutral-50 py-8 mt-8 px-[40px] md:px-[20px] flex flex-col items-start dark:bg-neutral-990">
      ...
      <div className="flex flex-wrap gap-4  ml-[40px] mt-3 md:ml-[120px] ">
        <div className="px-3 py-2 md:px-6 md:py-3 rounded-full border border-neutral-990 text-xs md:text-sm font-medium text-neutral-990 dark:text-neutral-100 dark:bg-neutral-990 ">
          esiflow@esi.dz
        </div>
        <div className="px-3 py-2 md:px-6 md:py-3 rounded-full border border-neutral-990 text-xs md:text-sm font-medium text-black dark:text-white bg-neutral-50 dark:bg-neutral-990">
          +213 (0) 555 55 55 55
        </div>
      </div>
    </div>
