...
const roleNavItems = {
  admin: [
    ...
    { key: "requests", icon: <Mail size={18} /> },
    { key: "equipment", icon: <Shield size={18} /> },
    { key: "tasks", icon: <CheckCheckIcon size={18} /> },
    { key: "users", icon: <User size={18} /> },
    { key: "reports", icon: <BarChart2 size={18} /> },
    { key: "notifications", icon: <Bell size={18} /> },
    ...
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 h-16 bg-card-bg shadow-md z-40 flex items-center justify-between px-4">
        ...
        <div className="flex justify-center">
            <img src="/home/hero/logo12.svg" alt="Logo" className='dark:hidden h-10 w-16' />
            <img src="/home/hero/logo1-dark.svg" alt="Logo Dark" className='hidden dark:block h-10 w-16' />
        </div>
      </header>
      ...
      >
        <div className="bg-card-bg h-screen flex flex-col">
          ...
          <div className="mt-3 p-3 flex justify-center items-center">
            <img src="/home/hero/logo12.svg" alt="Logo" className='dark:hidden h-12 w-20' />
            <img src="/home/hero/logo1-dark.svg" alt="Logo Dark" className='hidden dark:block h-12 w-20' />
          </div>
